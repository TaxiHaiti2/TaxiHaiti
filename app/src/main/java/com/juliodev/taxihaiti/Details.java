...
public class Details extends AppCompatActivity {
    ...
    public void setUpViews() {
        ...
        TextView tvName = (TextView) findViewById(R.id.facTvName);
        ...
        String myProfileImg = user.getPhotoUser();
        Picasso.with(this).load(myProfileImg).placeholder(R.drawable.ic_action_userform).transform(new RoundedTransformation(100, 0)).centerCrop().into(ivProfil);
